...
public class RightViewOfBinaryTree {
    ...
    // tarika 1 -> agar left se right traverse karenge to array k andar k value ko bar - bar overwrite karna padega
    ...
    // tarika 2 -> agar right se left traverse karenge to array k andar k value ko bar - bar overwrite nahi karna padega
    private static void view(Node root, int level, List<Integer> ans) {
        if(root == null) return;
    ...
    public static void main(String[] args) {
        ...
        // agar ye attach kar denge to ans [3, 2, 9, 7, 8] ho jayega
        //         \
        //          7
        //           \
        //            8
        ...
        System.out.println("right view is: "+ rightView(a));
    }
}
