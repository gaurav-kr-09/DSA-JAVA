...
public class PathsFromRootWithSpecificSum {
    ...
    private static void dfs(Node root, ArrayList<ArrayList<Integer>> ans, ArrayList<Integer> temp, int sum){
        ...
        if(sum == root.val){
            ...
            // return; // yaha return nahi karenge kyuki ho sakta hai ki aage agar -ve value mile fir positive to wo v ek naya rasta ho sakta hai
        }
    ...
    public static void main(String[] args) {
        ...
        int sum = 38; // paths: [10, 28] and [10, 13, 15]
